...
#define MAX_DEFINED_TYPE 11 // Max allowed copying field's tag's type. 1-12 tags supported
...
// I recommend using it with this parameter only for files with size < 3-4 Mb
